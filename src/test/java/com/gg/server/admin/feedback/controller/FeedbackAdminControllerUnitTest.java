...
class FeedbackAdminControllerUnitTest {
    ...
    class FeedbackAllUnitTest {
        ...
        public void successWithIntraId() {
            ...
            given(feedbackAdminService.findByPartsOfIntraId(any(String.class), any(Pageable.class))).willReturn(mock(FeedbackListAdminResponseDto.class));
            // when, then
        ...
        public void successWithoutIntraId() {
            ...
            given(feedbackAdminService.findAllFeedback(any(Pageable.class))).willReturn(mock(FeedbackListAdminResponseDto.class));
            // when, then
            feedbackAdminController.feedbackAll(requestDto);
        }
    }
