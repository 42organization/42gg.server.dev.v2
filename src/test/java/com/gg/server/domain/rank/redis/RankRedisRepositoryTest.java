...
class RankRedisRepositoryTest {
    ...
    public void updateRank () throws Exception
    {
        ...
        RankRedis newRanking = new RankRedis(userId, "aa", newPpp, newWin, newLose, newStatusMessage, "aa", "aa");
    ...
    void findRanksByUserIds() {
        ...
        RankRedis rank1 = new RankRedis(userId, "aa", ppp,  0, 0, "statusMessage", "aa", "aa");
        RankRedis rank2 = new RankRedis(userId2,"aa", ppp2,  0, 0, "statusMessage", "aa", "aa");
        RankRedis rank3 = new RankRedis(userId3, "aa", ppp3,  0, 0, "statusMessage", "aa", "aa");
        RankRedis rank4 = new RankRedis(userId4, "aa", ppp4,  0, 0, "statusMessage", "aa", "aa");
